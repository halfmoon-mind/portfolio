...
OpenRouter 블로그에서 [Fusion beats Frontier](https://openrouter.ai/blog/announcements/fusion-beats-frontier/)라는 글을 읽었다. 요지는 단순하다. 여러 모델의 출력을 judge 모델로 합성하면 가장 좋은 단일 모델(frontier) 하나보다 나은 결과가 나온다는 것이다.
...
그래서 [fusion-council](https://github.com/halfmoon-mind/fusion-council)을 만들었다. Claude Code 플러그인이고, 커맨드는 두 개다.
